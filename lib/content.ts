...
export const sections: Section[] = [
  {
    ...
    blocks: [
      {
        p: "i will preface this with the following: most of what i've done, and most of what i'm doing now, are driven by pure interest: teaching myself, and learning from people who know *way* more than i do.",
      },
      {
  ...
  },
  {
    ...
    blocks: [
      {
        p: `the paper trail of "ooh" complemented by a brief detour into "what can i do today to enhance shareholder value"`,
      },
    ],
    events: [
      {
